...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        choices=["ER", "PR", "HER2", "Ki67"],
        help="IHC marker tipi — model bu bilgiyle daha iyi tahmin yapar (ER/PR/HER2/Ki67)",
    )
    params = vars(parser.parse_args())
    # marker_id'yi sayıya çevir
    marker_map = {"ER": 0, "PR": 1, "HER2": 2, "Ki67": 3}
    params["marker_id"] = marker_map.get(params.get("marker"), None)
    main(params)
